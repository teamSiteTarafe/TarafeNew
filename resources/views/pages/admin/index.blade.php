@extends('../layouts.masterpages', ["title" => 'Administration'])

@section('page-name') ADMINISTRATEUR @endsection
...
@section('authentification')
    ...
    @else
        <div class="div_connexion">
            <div class="div_connexion2">
                <span class="0separator00"></span>
                <a href="{{ route('page.deconnexion.admin') }}" class="btn nbt">Déconnexion</a>
            </div>
        </div>
    @endif
