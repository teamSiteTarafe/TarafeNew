...
@section("content")
    ...
    <div class="container00">
        ...
        <form method="POST" action="{{ route('connexion.admin') }}">
            ...
            <!-- <input type="hidden" name="page" value="{{ isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : route('page.admin') }}"> -->
        ...
        <p class="creer">
            ...
            <a href="{{ route('page.inscription.admin') }}">Créez en un ici</a>
        </p>
    </div>
