...
@section("content")
    ...
    <div class="container00">
        ...
        <form method="POST" action="{{ route('connexion.boutique') }}">
            ...
            <!-- <input type="hidden" name="page" value="{{ isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : route('page.boutique') }}"> -->
        ...
        <p class="creer">
            ...
            <a href="{{ route('page.inscription.boutique') }}">Créez en un ici</a>
        </p>
    </div>
